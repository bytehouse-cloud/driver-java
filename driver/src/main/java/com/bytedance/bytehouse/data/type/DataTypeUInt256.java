...
public class DataTypeUInt256 implements BaseDataTypeInt64<BigInteger, BigInteger>, BytesHelper {
    ...
    @Override
    public void serializeBinary(BigInteger data,
                                BinarySerializer serializer) throws SQLException, IOException {
        serializer.writeLong(data.longValue());
        serializer.writeLong(data.shiftRight(64).longValue());
        serializer.writeLong(data.shiftRight(64 * 2).longValue());
        serializer.writeLong(data.shiftRight(64 * 3).longValue());
    }

    @Override
    public BigInteger deserializeBinary(
            BinaryDeserializer deserializer) throws SQLException, IOException {
        long[] array = new long[4];
        array[3] = deserializer.readLong();
        array[2] = deserializer.readLong();
        array[1] = deserializer.readLong();
        array[0] = deserializer.readLong();
        return new BigInteger(1, getBytes(array));
    }
